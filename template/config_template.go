...
settings:
  ...
  at_markdown : false               #真实at(markdown)开关: 官方文本链<qqbot-at-user id="openid"/>实测不渲染(显示原文), 官方开发者实测markdown消息内嵌<at id="openid"></at>可渲染真at; 开启后含at的群文本消息升级为markdown消息(msg_type=2)发送, at渲染为真@; false=维持"@昵称"文本(默认)
